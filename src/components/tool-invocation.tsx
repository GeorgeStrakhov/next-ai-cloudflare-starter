...
export function ToolInvocationPart({
  ...
  // Route to tool-specific components - wrapped with consistent margin
  const toolComponent = (() => {
    switch (toolName) {
      case "weather":
      ...
      default:
        ...
        return (
          <div className="rounded-lg border bg-muted/30 overflow-hidden p-4">
  ...
  return <div className="my-3">{toolComponent}</div>;
}
